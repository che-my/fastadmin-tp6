...
class Index extends Backend
{
    ...
    public function login()
    {
        ...
        if ($this->request->isPost()) {
            ...
            $message = ['username' => __('Username'), 'password' => __('Password')];
            if (Config::get('fastadmin.login_captcha')) {
                $result = captcha_check($this->request->post('captcha'));
                if (!$result) {
                    $this->error("验证码错误！");
                }
            }
            ...
            if ($result === true) {
                event("admin_login_after", $this->request);
    ...
    {
        $this->auth->logout();
        event("admin_logout_after", $this->request);

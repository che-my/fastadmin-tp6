...
use fast\Random;
use think\addons\addons\Service;
...
class Ajax extends Backend
{
    ...
    public function upload()
    {
        ...
        if ($splInfo) {
            ...
            $attachment->save();
            event("upload_after", $attachment);
            $result = ['code'=>1,'msg'=>__('Upload successful'),'url'=>null,'data'=>['url'=>$uploadDir . $splInfo->getSaveName()]];
        } else {
            $result = ['code'=>0,'msg'=>$file->getError(),'url'=>null,'data'=>''];
        }
        return json($result);
    }

...
-- Records of fa_admin
-- ----------------------------
INSERT INTO `fa_admin` VALUES (1, 'admin', 'Admin', '233070b52e705a660fb1bc45b928fe1e', '7608b2', '/assets/img/avatar.png', 'admin@admin.com', 0, 1559986030, 1492186163, 1559986030, 'af98e453-3e1e-41f4-ae80-b022549bf0e5', 'normal');
-- ----------------------------
...
) ENGINE = InnoDB AUTO_INCREMENT = 538 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '管理员日志表' ROW_FORMAT = Compact;
...
-- ----------------------------
INSERT INTO `fa_attachment` VALUES (1, 1, 0, '/assets/img/qrcode.png', '150', '150', 'png', 0, 21859, 'image/png', '', 1499681848, 1559909564, 1499681848, 'local', '17163603d0263e4838b9387ff2cd4877e8b018f6');
...
) ENGINE = InnoDB AUTO_INCREMENT = 119 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '节点表' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of fa_auth_rule
-- ----------------------------
INSERT INTO `fa_auth_rule` VALUES (1, 'file', 0, 'dashboard', 'Dashboard', 'fa fa-dashboard', '', 'Dashboard tips', 1, 1497429920, 1559918750, 143, 'normal');
...
INSERT INTO `fa_auth_rule` VALUES (5, 'file', 0, 'auth', 'Auth', 'fa fa-group', '', '', 1, 1497429920, 1559918728, 99, 'normal');
...
INSERT INTO `fa_auth_rule` VALUES (66, 'file', 0, 'user', 'User', 'fa fa-list', '', '', 1, 1516374729, 1559918503, 0, 'normal');
...
INSERT INTO `fa_auth_rule` VALUES (96, 'file', 0, 'command', '在线命令管理', 'fa fa-terminal', '', '', 1, 1559934120, 1559934120, 0, 'normal');
INSERT INTO `fa_auth_rule` VALUES (97, 'file', 96, 'command/index', '查看', 'fa fa-circle-o', '', '', 0, 1559934152, 1559934246, 0, 'normal');
INSERT INTO `fa_auth_rule` VALUES (98, 'file', 96, 'command/add', '添加', 'fa fa-circle-o', '', '', 0, 1559934174, 1559934250, 0, 'normal');
INSERT INTO `fa_auth_rule` VALUES (99, 'file', 96, 'command/detail', '详情', 'fa fa-circle-o', '', '', 0, 1559934191, 1559934254, 0, 'normal');
INSERT INTO `fa_auth_rule` VALUES (100, 'file', 96, 'command/execute', '运行', 'fa fa-circle-o', '', '', 0, 1559934207, 1559934264, 0, 'normal');
INSERT INTO `fa_auth_rule` VALUES (101, 'file', 96, 'command/del', '删除', 'fa fa-circle-o', '', '', 0, 1559934222, 1559934262, 0, 'normal');
INSERT INTO `fa_auth_rule` VALUES (102, 'file', 96, 'command/multi', '批量更新', 'fa fa-circle-o', '', '', 0, 1559934239, 1559934259, 0, 'normal');
INSERT INTO `fa_auth_rule` VALUES (103, 'file', 0, 'test', '测试管理', 'fa fa-circle-o', '', '', 1, 1559944865, 1559944865, 0, 'normal');
INSERT INTO `fa_auth_rule` VALUES (104, 'file', 103, 'test/index', '查看', 'fa fa-circle-o', '', '', 0, 1559944877, 1559995988, 0, 'normal');
INSERT INTO `fa_auth_rule` VALUES (105, 'file', 103, 'test/add', '添加', 'fa fa-circle-o', '', '', 0, 1559944877, 1559995988, 0, 'normal');
INSERT INTO `fa_auth_rule` VALUES (106, 'file', 103, 'test/edit', '编辑', 'fa fa-circle-o', '', '', 0, 1559944877, 1559995988, 0, 'normal');
INSERT INTO `fa_auth_rule` VALUES (107, 'file', 103, 'test/del', '删除', 'fa fa-circle-o', '', '', 0, 1559944877, 1559995988, 0, 'normal');
INSERT INTO `fa_auth_rule` VALUES (108, 'file', 103, 'test/multi', '批量更新', 'fa fa-circle-o', '', '', 0, 1559944877, 1559995988, 0, 'normal');
INSERT INTO `fa_auth_rule` VALUES (109, 'file', 0, 'text', 'text', 'fa fa-list', '', '', 1, 1560007419, 1560007419, 0, 'normal');
INSERT INTO `fa_auth_rule` VALUES (110, 'file', 109, 'text.test', '测试管理', 'fa fa-circle-o', '', '', 1, 1560007976, 1560007976, 0, 'normal');
INSERT INTO `fa_auth_rule` VALUES (111, 'file', 110, 'text.test/index', '查看', 'fa fa-circle-o', '', '', 0, 1560008361, 1560008361, 0, 'normal');
INSERT INTO `fa_auth_rule` VALUES (112, 'file', 110, 'text.test/recyclebin', '回收站', 'fa fa-circle-o', '', '', 0, 1560008361, 1560008361, 0, 'normal');
INSERT INTO `fa_auth_rule` VALUES (113, 'file', 110, 'text.test/add', '添加', 'fa fa-circle-o', '', '', 0, 1560008361, 1560008361, 0, 'normal');
INSERT INTO `fa_auth_rule` VALUES (114, 'file', 110, 'text.test/edit', '编辑', 'fa fa-circle-o', '', '', 0, 1560008361, 1560008361, 0, 'normal');
INSERT INTO `fa_auth_rule` VALUES (115, 'file', 110, 'text.test/del', '删除', 'fa fa-circle-o', '', '', 0, 1560008361, 1560008361, 0, 'normal');
INSERT INTO `fa_auth_rule` VALUES (116, 'file', 110, 'text.test/destroy', '真实删除', 'fa fa-circle-o', '', '', 0, 1560008361, 1560008361, 0, 'normal');
INSERT INTO `fa_auth_rule` VALUES (117, 'file', 110, 'text.test/restore', '还原', 'fa fa-circle-o', '', '', 0, 1560008361, 1560008361, 0, 'normal');
INSERT INTO `fa_auth_rule` VALUES (118, 'file', 110, 'text.test/multi', '批量更新', 'fa fa-circle-o', '', '', 0, 1560008361, 1560008361, 0, 'normal');
...
-- Records of fa_user
-- ----------------------------
INSERT INTO `fa_user` VALUES (1, 1, 'admin', 'admin', 'c13f62012fd6a8fdf06b3452a94430e5', 'rpR6Bv', 'admin@163.com', '13888888888', '', 0, 0, '2017-04-15', '', 0.00, 0, 1, 1, 1516170492, 1516171614, '127.0.0.1', 0, '127.0.0.1', 1491461418, 0, 1559925342, '', 'normal', '');
...
CREATE TABLE `fa_user_group`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '会员组表' ROW_FORMAT = Compact;
...
INSERT INTO `fa_user_rule` VALUES (2, 0, 'api', 'API接口', '', 1, 1516168062, 1559925772, 2, 'normal');
INSERT INTO `fa_user_rule` VALUES (3, 1, 'user', '会员模块', '', 1, 1515386221, 1516168103, 12, 'normal');
INSERT INTO `fa_user_rule` VALUES (4, 2, 'user', '会员模块', '', 1, 1515386221, 1559925760, 11, 'normal');

define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'text.test/index' + location.search,
                    add_url: 'text.test/add',
                    edit_url: 'text.test/edit',
                    del_url: 'text.test/del',
                    multi_url: 'text.test/multi',
                    table: 'test',
                }
            });
        ...
        recyclebin: function () {
            ...
            // 初始化表格
            table.bootstrapTable({
                url: 'text.test/recyclebin' + location.search,
                pk: 'id',
                sortName: 'id',
                columns: [
                    [
